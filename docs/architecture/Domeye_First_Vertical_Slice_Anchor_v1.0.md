...
> 本合同固定 M0/M1 的第一个可验收纵向切片。它以一条真实、受约束的 RRC25 BGP 控制面证据调查为锚，不以架构层、模块、Issue 或 PR 数量代替用户旅程。

| 项目 | 固定值 |
|---|---|
| 产品展示名称 | `RRC25 BGP 控制面证据调查` |
...
修改固定问题、数据身份、指标、Tool、Operator、回答链、J1–J5、阈值或硬边界，必须：

<template>
	<el-container class="layout-container">
		<LayoutAside v-show="!themeConfig.isFullScreen" />
		<el-container class="layout-container-view h100">
			<el-scrollbar ref="layoutScrollbarRef" class="layout-backtop" v-show="!themeConfig.isShowDemo">
				<LayoutHeader />
				<LayoutMain ref="layoutMainRef" v-if="!themeConfig.isShowDemo" />
			</el-scrollbar>
      <LayoutMain ref="layoutMainRef" v-if="themeConfig.isShowDemo" />
		</el-container>
	</el-container>

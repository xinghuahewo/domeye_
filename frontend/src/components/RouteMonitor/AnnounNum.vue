...
// import { LineChart } from 'echarts/charts'; // 导入折线图组件
export default {
		name: 'announceNum',
		props: ['subdata'],	// 整个事件
		data() {
			return {
				charts: '',
				opinionData: this.subdata.announ_list  // 纵轴数据
			...
			drawLine(id) {
				...
				this.charts.setOption({
					...
					series: [{
						...
						animation: true,   // 如果为了前端展示，此处可以设置为true; 如果为了导出图片，此处必须为false
						...
						data: this.subdata.announ_list
					}],
				})

				console.log(this.charts.getDataURL())
			}
		},
		//调用
		mounted() {

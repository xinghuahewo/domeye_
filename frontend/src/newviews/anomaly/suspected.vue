...
<!--					<el-select v-model="judgeruleForm.judge_result">-->
<!--						<el-option label="疑似事件" value="suspected" />-->
<!--						<el-option label="待通报事件" value="notify" />-->
<!--						<el-option label="误报事件" value="misreport" />-->
<!--					</el-select>-->
				</el-form-item>
			</el-form>
			<template #footer>
          ...
          <el-table-column prop="level" label="事件等级" width="110" sortable="custom">
            <template #default="scope">
              <span :class="{highLevel: scope.row.level === '高危事件', middleLevel: scope.row.level === '中危事件', lowLevel: scope.row.level === '低危事件'}">{{ scope.row.level }}</span>
					...
					<el-table-column prop="judge_username" width="100" label="研判人" sortable="custom" />

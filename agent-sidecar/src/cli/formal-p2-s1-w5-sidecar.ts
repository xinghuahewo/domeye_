...
import { P2S1W5IntegratedAnswerRuntime } from '../chat/p2-s1-integrated-answer-runtime.js'
import {
...
export function createFormalP2S1W5Sidecar(
  ...
  const listener = createP2S1W5HttpHandler({
    ...
    integratedAnswerRuntimeEnabled: true,
    integratedAnswerRuntime: new P2S1W5IntegratedAnswerRuntime(
      `${config.artifactStorePath ?? required(env, 'COUNTRY_OUTAGE_P2_S1_W5_ARTIFACT_STORE')}/integrated-answer`,
    ),
  })

...
STAGE_TEST_RUN_RECEIPTS = {
    ...
    "w5-python": ("W5", "runtime_api_result_graph_export_and_cas", "PENDING_W5_REAL_RUN"),
    "w5-openapi": ("W5", "openapi_contract_and_generated_types", "PENDING_W5_REAL_RUN"),
    "w5-sidecar": ("W5", "local_fixture_sol_host_ds_chain", "PENDING_W5_REAL_RUN"),
    "w5-frontend": ("W5", "ui_journey_typecheck_and_build", "PENDING_W5_REAL_RUN"),
}
...
W5_W4_ACTUAL_SNAPSHOT_ID = (
    ...
    "a09794d44b274789f138bdadb5538f57cd8930aecbfbf3892c80ca22fb849af1"
)
W5_W4_ACTUAL_SNAPSHOT_DIGEST = (
    "sha256:a09794d44b274789f138bdadb5538f57cd8930aecbfbf3892c80ca22fb849af1"
)
...
def validate_w5_evidence(root: Path, evidence: dict[str, Any]) -> list[str]:
    ...
    output_markers = {
        ...
        "w5-openapi": ("7 passed", "OpenAPI 生成类型与契约一致"),
    ...
    exact(receipts["w5-openapi"]["tests_run"], 7, "w5_test_count_mismatch", "OpenAPI 必须实际运行 7 测")
    ...
    exact(receipts["w5-frontend"]["tests_run"], 13, "w5_test_count_mismatch", "Frontend 必须实际运行 13 测")

...
COUNTRY_OUTAGE_INTERACTIVE_AGENT_IDENTITY_MODE=internal_fixed_history
COUNTRY_OUTAGE_INTERACTIVE_AGENT_INTERNAL_USER_ID=domeye-first-slice-interactive-user-v1

...
validate_config() {
    ...
    [[ "$(read_config_value COUNTRY_OUTAGE_AGENT_URL)" == 'http://127.0.0.1:28476' \
        ...
        && "$(read_config_value COUNTRY_OUTAGE_INTERACTIVE_AGENT_IDENTITY_MODE)" == 'internal_fixed_history' \
        && "$(read_config_value COUNTRY_OUTAGE_INTERACTIVE_AGENT_INTERNAL_USER_ID)" == 'domeye-first-slice-interactive-user-v1' \
